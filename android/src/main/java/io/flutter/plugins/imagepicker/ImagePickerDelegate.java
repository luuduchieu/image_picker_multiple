...
public class ImagePickerDelegate
    ...
    @VisibleForTesting
    static final int REQUEST_CODE_CHOOSE_IMAGES_FROM_GALLERY = 23421;
    @VisibleForTesting
    ...
    private void launchPickImageFromGalleryIntent() {
        int numberOfItemss = methodCall.argument("numberOfItems");
        if (numberOfItemss < 2) {
            ...
            activity.startActivityForResult(Intent.createChooser(pickImageIntent, "Select Picture"), REQUEST_CODE_CHOOSE_IMAGES_FROM_GALLERY);
        }
    }
