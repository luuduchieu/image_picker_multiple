    ...
    setState(() {
      ...
      if (isVideo) {
        ImagePicker.pickVideo(source: source).then((File file) {
          ...
          _imageFile = ImagePicker.pickImages(
              source: source, numberOfItems: numberOfItems);
      }
    });
  }
        ...
        children: <Widget>[
          ...
          Padding(
            ...
            child: FloatingActionButton(
              onPressed: () {
                isVideo = false;
                _onImageButtonPressed(ImageSource.gallery, 2);
              },
              heroTag: 'image1',
              tooltip: 'Pick Image from gallery',
          ...
          Padding(
            ...
            child: FloatingActionButton(
              onPressed: () {
                isVideo = false;
                _onImageButtonPressed(ImageSource.camera, 1);
              },
              heroTag: 'image2',
